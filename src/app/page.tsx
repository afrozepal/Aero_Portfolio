...
export default function Home() {
  ...
  return (
    <div className="bg-gradient-to-br from-black via-purple-900 to-black">
      ...
      <nav className="sticky top-0 z-50 flex items-center justify-between p-4 md:p-6 backdrop-blur-md bg-black/30 border-b border-white/10">
          ...
          <div className="md:hidden">
            <button className="text-white hover:text-purple-300 transition-colors duration-300">
